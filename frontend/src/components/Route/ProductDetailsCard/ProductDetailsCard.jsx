...
const ProductDetailsCard = ({ setOpen, data }) => {
  ...
  const handleMessageSubmit = async () => {
    if (isAuthenticated) {
      ...
      toast.error("Please login to send a message to seller!");
    }
  };
  ...
  return (
    <div className="bg-[#fff]">
      {data ? (
        <div className="fixed w-full h-screen top-0 left-0 bg-[#00000030] z-40 flex items-center justify-center p-4">
          <div className="w-[90%] 800px:w-[60%] h-[90vh] overflow-y-auto 800px:h-[75vh] bg-white rounded-md shadow-sm relative p-4">
            ...
            <div className="block w-full 800px:flex pt-6">
              <div className="w-full 800px:w-[50%] flex flex-col items-center">
                ...
                >
                  <span className="text-[#fff] flex items-center text-sm font-medium">
